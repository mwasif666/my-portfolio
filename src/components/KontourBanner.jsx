...
export default function KontourBanner({
  ...
  return (
    ...
    >
      {theme === "blue" && (
        <div
          className="portfolio-loader-background absolute inset-0 opacity-[0.42] mix-blend-screen"
          aria-hidden="true"
        >
      ...
      >
        ...
        >
          <div
            className={clsx(
              styles.portraitGlow,
              "absolute inset-[15%_3%_2%] blur-[1.3rem]",
            )}
            aria-hidden="true"
          />
          <img
      ...
      {/* Sits inside the section so the hero's own gradient layers keep
          running behind it - no seam, no second-section look. */}
      {theme === "blue" && (
